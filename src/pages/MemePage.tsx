      ...
      <div className='flex gap-8'>
        <div className='flex flex-col grow w-full justify-between'>
          ...
          <div className='jail-container w-full' ref={jailRef}>
            ...
            >
              <path
                d='M30 15C30 6.71573 23.2843 0 15 0C6.71574 0 0 6.71573 0 15C0 23.2843 6.71574 30 15 30C23.2843 30 30 23.2843 30 15Z'
                fill='#FF0209'
              />
              <path
                d='M21.3676 21.6431C20.9206 21.6916 20.4632 21.7 20.0247 21.699C16.6044 21.6958 13.184 21.6926 9.76471 21.6905C8.68854 21.6905 7.51645 21.6557 6.68482 20.9717C5.74778 20.1991 5.55278 18.8594 5.47689 17.6472C5.37149 15.9861 5.36306 14.3196 5.44949 12.6574C5.49692 11.7446 5.58019 10.8097 5.97334 9.98333C6.25582 9.38991 6.72698 8.85657 7.32989 8.5762C8.03082 8.2505 8.76443 8.30847 9.51912 8.30742C11.3257 8.30531 13.1324 8.30426 14.939 8.30215C16.8173 8.30004 18.6966 8.29898 20.5749 8.29688C21.4624 8.29688 22.4153 8.31479 23.1394 8.82811C24.0743 9.49005 24.3283 10.7496 24.4453 11.889C24.6614 13.9876 24.6646 16.1083 24.4538 18.2069C24.3663 19.0723 24.2208 19.9872 23.6506 20.6439C23.0856 21.2953 22.2477 21.5461 21.3686 21.642L21.3676 21.6431Z'
                fill='white'
              />
              <path
                d='M18.0595 14.9986L12.9622 12.0547V17.9415L18.0595 14.9986Z'
                fill='#FF0209'
              />
            </svg>
          </div>
